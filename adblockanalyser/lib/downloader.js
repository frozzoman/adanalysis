...
Downloader.prototype =
{
  ...
  _doCheck: function()
  {
    Components.utils.reportError("docheck downloader.js");
    let now = Date.now();
  ...
  {
    Components.utils.reportError(urk+" isDownloading downloader.js");
  ...
  getDownloadUrl: function(/**Downloadable*/ downloadable)  /** String*/
  {
    ...
    Components.utils.reportError("DOWNLOADER: "+url);
    return url;
  },

  _download: function(downloadable, redirects)
  {
    Components.utils.reportError("download downloader.js");
